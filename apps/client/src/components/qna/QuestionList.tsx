...
function QuestionList() {
  ...
  return (
    <div className='inline-flex h-full w-4/5 flex-grow flex-col items-center justify-start gap-4 rounded-lg bg-white shadow'>
      ...
      <div className='inline-flex h-full w-full flex-col items-start justify-start gap-4 overflow-y-auto px-8 pb-4 pt-2'>
        {/* TODO: 질문 목록으로 변경 필요 */}
        <Question
          body={
